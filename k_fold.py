'''
this version is for three categories
'''
import random
import os


def k_fold_pre(filename, image_list_file, fold, num_classes):  # 生成的是源文件的5-fold序号
    # num为原始样本数量
    # 数据集的 5-fold 数据准备
